...
public class Metodos {
    ...
    public void crearArray(){
        Libros lib1= new Libros("Libro1","Carlos",15f,0);
        Libros lib2=new Libros("Libro2","Juan",42f,3);
        Libros lib3=new Libros("Libeo3","Pedro",13f,1);
        Libros lib4=new Libros("Libro4","Pipo",32f,5);
        lista.add(lib1);
        lista.add(lib2);
        lista.add(lib3);
        lista.add(lib4);
